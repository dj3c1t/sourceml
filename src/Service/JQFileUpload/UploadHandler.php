...
/*
 * cette classe est une adaptation en service Symfony de
 * la classe PHP UploadHandler, fournie dans la librairie :
 *
...
class UploadHandler
{
    ...
    public function handle($options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
...
//                    move_uploaded_file($uploaded_file, $file_path);
    ...
    public function delete($print_response = true) {
        ...
        foreach($file_names as $file_name) {
            $response[$file_name] = $this->delete_file($file_name);
        }
        return $response;
    }
    ...
    public function delete_file($file_name) {
        ...
        $success = $file_name[0] !== '.' && unlink($file_path);
        if($success) {
            foreach($this->options['image_versions'] as $version => $options) {
                if(!empty($version)) {
